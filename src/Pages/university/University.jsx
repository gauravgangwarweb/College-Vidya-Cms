...
import { useUni } from "../../state/homeState"
        ...
        <div className='w-full max-w-[1320px] py-8'>
            ...
            <div>
                <div className='flex justify-between items-center'>
                    <h4 className='text-3xl font-semibold mt-5'>Universities List</h4>
                    <Link to='/university/new' className='bg-primary text-white font-medium px-4 py-1 rounded-md mt-5'>
                        New University
                    </Link>
                </div>
                        ...
                        universities.map((university, index) => (
                            <div
                                ...
                                <div className='flex items-center gap-2'>
                                    <img src={university.icon} alt='' className='w-20 h-10' />
                                    <h4 className='text-lg font-semibold'>{university.name}</h4>
                                </div>
                                <div className='flex gap-2'>
                                    <Link to={`/university/${university.id}/course`} className='bg-yellow-500 text-white font-medium px-4 py-1 rounded-md'>
                                        Courses
                                    </Link>
